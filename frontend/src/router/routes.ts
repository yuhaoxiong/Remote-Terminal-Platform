...
export const SECTION_ROUTES: RouteRecordRaw[] = [
  { path: "/dashboard", name: "dashboard", component: DashboardPanel, meta: { requiresAuth: true, label: "仪表盘" } },
  ...
  { path: "/diagnostics", name: "diagnostics", component: DiagnosticsPanel, meta: { requiresAuth: true, label: "系统诊断" } },
  {
    path: "/settings",
    name: "settings",
