...
class Device(Base):
    ...
    initialization_status: Mapped[str] = mapped_column(String(32), default="draft", index=True)
    vnc_status: Mapped[str] = mapped_column(String(32), default="unconfigured", index=True)
    bootstrap_generation: Mapped[int] = mapped_column(Integer, default=1)
    machine_id_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
    mac_fingerprint_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
